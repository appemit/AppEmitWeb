...
最新版本 AppEmit  v1.0.12	   [ English version ](https://github.com/appemit/appemit/blob/master/README.md)

1. 内容分发*下载*(更新有滞后,注意版本) [地址1](https://cdn.jsdelivr.net/gh/appemit/appemit@master/dist/AppEmit.zip)   [地址2](https://cdn.jsdelivr.net/gh/appemit/appemit/dist/AppEmit.zip)
