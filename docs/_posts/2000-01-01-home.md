...
1. [内容分发*下载* 地址1(更新有滞后)](https://cdn.jsdelivr.net/gh/appemit/appemit@master/dist/AppEmit.zip)   [内容分发*下载* 地址2(更新有滞后)](https://cdn.jsdelivr.net/gh/appemit/appemit/dist/AppEmit.zip)
